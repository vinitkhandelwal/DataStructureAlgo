...
public class MissingRepeatNumber {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(missingRepeatNumber.repeatedNumber(list));
    ...
    public ArrayList<Integer> repeatedNumber(final List<Integer> A) {
        ...
        long arraySum = A.stream().mapToLong(i -> i).sum();
        int sumDifference = (int) ( sum-arraySum);
        int missingNumber = 0;
        int dups = 0;
        ...
        missingNumber = dups+sumDifference;
